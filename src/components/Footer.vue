...
const column1Heading = "About RabGuard";
const column1Text =
  "A Patient Management and vaccination Scheduling System for Animal Bite Patients in Olongapo City";
...
const socialItems = [
  ...
  {
    link: "https://www.facebook.com/profile.php?id=61565599327030",
    icon: "icon-facebook",
  },
  {
